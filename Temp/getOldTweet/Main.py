...
if __name__ == '__main__':
	...
	tweetCriteria = got.manager.TweetCriteria().setQuerySearch('#AIDS').setLang('en').setSince("2001-01-01").setUntil("2018-01-01").setMaxTweets(30000)
	...
	with open('tweet_AIDS.json', 'w') as outfile:
